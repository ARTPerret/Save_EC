...
func update_trash_count() -> void:
	...
	if trash_count == max_trash_items:
		...
		EventBus.emit_signal("remove_item", "Trash_bas1")
		EventBus.emit_signal("remove_item", "Trash_bas2")
		EventBus.emit_signal("remove_item", "Trash_bas3")
		EventBus.emit_signal("remove_item", "Trash_bas4")
		EventBus.emit_signal("remove_item", "Trash_haut1")
		EventBus.emit_signal("remove_item", "Trash_haut2")
		EventBus.emit_signal("remove_item", "Trash_haut3")
		EventBus.emit_signal("remove_item", "Trash_haut4")
